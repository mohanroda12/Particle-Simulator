...
public class Simulation {
    ...
    public void simulateTick(ParticleBoxPanel simUI) {
        for (Particle particle : particles) {
            double forceY = particle.forceDueToGravity(planet);
            double forceX = particle.frictionalForce(particle.getDampingFactor(), planet);
    ...
    public static void main(String[] args) {
        ...
        Particle ball = new Particle(0.5, 0.5, 5, 0.05, 0.45);
        particles.add(ball);
        Particle ball2 = new Particle(0.3, 0.6, 2, 0.08, 0.65);
        particles.add(ball2);
        Particle ball3 = new Particle(0.5, 0.5, 20, 0.02, 0.75);
        particles.add(ball3);
